...
export class CollectionDetailComponent implements OnInit, OnDestroy {
    ...
    constructor(private jsonp: Jsonp, private http: Http, private sanitizer: DomSanitizationService, private route: ActivatedRoute, private router: Router, private service: CollectionService) {
    }
